...
You're using ClashT open-source edition. Rule Providers is currently only available in the [Premium core](https://github.com/Dreamacro/clash/releases/tag/premium). (it's free)
...
2. Or manually set up your system DNS to the ClashT DNS (by default, `198.18.0.1`)
